...
from uflow import GET_PACKAGES
from uflow.Core.PathsRegistry import PathsRegistry
from uflow.UI.Widgets.EnumComboBox import EnumComboBox
from uflow.UI.Widgets.InputWidgets import *
from uflow.UI.Widgets.QtSliders import *
from uflow.UI.Widgets.FileDialog import FileDialog
...
def getInputWidget(
    ...
    for pkgName, pkg in GET_PACKAGES().items():
        ...
        # Note: pkgName is the entry point name from pyproject.toml (e.g., "base-pack"), not the class name
        if pkgName in ["FlowBasePackage"]:
            continue
