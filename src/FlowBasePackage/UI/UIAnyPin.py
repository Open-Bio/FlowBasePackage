...
from uflow.UI.Widgets.SelectPinDialog import SelectPinDialog
...
class UIAnyPin(UIPinBase):
    def __init__(self, owningNode, raw_pin):
        """UI wrapper for :class:`..Pins.AnyPin`

        :param owningNode: Owning node
        :type owningNode: :class:`uflow.UI.Canvas.NodeBase`
        :param raw_pin: PinBase reference
        :type raw_pin: :class:`..Pins.AnyPin.AnyPin`
        """
