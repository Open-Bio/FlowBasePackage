...
from uflow.UI.Tool.Tool import FormTool
from ..Tools import RESOURCES_DIR
from uflow.UI.Forms.PackageBuilder import PackageBuilder as PB
...
class PackageBuilder(FormTool):
    ...
    def do(self):
        self.uflowInstance.newFileFromUi(PB.PackageBuilder())
