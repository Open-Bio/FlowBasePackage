...
class IOLib(FunctionLibraryBase):
    ...
    @IMPLEMENT_NODE(
        returns=None,
        meta={NodeMeta.CATEGORY: "IO", NodeMeta.KEYWORDS: []},
    ...
    def copyFile(
        src=("StringPin", "", {PinSpecifiers.INPUT_WIDGET_VARIANT: "FilePathWidget"}),
    ...
    def copyDir(
        src=("StringPin", "", {PinSpecifiers.INPUT_WIDGET_VARIANT: "PathWidget"}),
    ...
    def pathCombine(
        p1=("StringPin", "", {PinSpecifiers.INPUT_WIDGET_VARIANT: "PathWidget"}),
        p2=("StringPin", ""),
    ):
    ...
    def removeDir(
        dir=("StringPin", "", {PinSpecifiers.INPUT_WIDGET_VARIANT: "PathWidget"}),
        ...
        try:
            if not os.path.isfile(file):
                ...
                rsp: requests.Response = requests.post(
                    url, {"file_path": store_path}, files={"file": open(file, "rb")}
                )
