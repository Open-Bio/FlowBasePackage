...
from uflow import getAllPinClasses
from uflow import findPinClassByType
...
class AnyPin(PinBase):
    ...
    By default, AnyPin non Initialized will be marked as error, as uflow can't know what is inside.
    This Error can be avoided by enabling :py:attr:`uflow.Core.Common.PinOptions.AllowAny`. That's how NonTyped Lists are made.

    By default, :py:attr:`uflow.Core.Common.PinOptions.ChangeTypeOnConnection` is enabled, and that means that it will change
    ...
    def __init__(self, name, owningNode, direction, **kwargs):
        ...
        :type owningNode: :py:class:`uflow.Core.NodeBase.NodeBase`
        :param direction: PinDirection , can be input or output
        :type direction: :py:class:`uflow.Core.Common.PinDirection`
        """
    ...
    def serialize(self):
        ...
        Appends current value and currentDataType to default :py:func:`uflow.Core.PinBase.PinBase.serialize` method
        :returns: json data
        :rtype: dict
        """
    ...
    def pinConnected(self, other):
        ...
        :type other: :py:class:`uflow.Core.PinBase.PinBase`
        """
    ...
    def aboutToConnect(self, other):
        """Function called before real connection but after :py:func:`uflow.Core.Common.canConnectPins` returns True
    ...
    def updateOnConnectionCallback(pin, dataType, init=False, other=None):
        """Method Called in traverse function :py:func:`uflow.Core.Common.traverseConstrainedPins`
        ...
        :type other: :py:class:`uflow.Core.PinBase.PinBase`, optional
        """
        free = pin.checkFree([])
        if free:
